...
public class Assert
{
	...
	public static void isNull(Object obj)
	{
		if (obj != null)
		{
			throw new TVerifierException(EXCEPTION_MESSAGE_IS_NULL);
		}
	}
	...
	public static void notNull(Object obj, String message)
	{
		if (obj == null)
		{
			throw (message == null) ? new TVerifierException(
					EXCEPTION_MESSAGE_NOT_NULL) : new TVerifierException(
	...
	public static void notEmpty(Object obj, String message)
	{
		...
		{
			throw (message == null) ? new TVerifierException(
					EXCEPTION_MESSAGE_NOT_EMPTY) : new TVerifierException(
	...
	public static void isTrue(boolean condition, String message)
	{
		...
		{
			throw (message == null) ? new TVerifierException(
					EXCEPTION_MESSAGE_IS_TRUE) : new TVerifierException(
